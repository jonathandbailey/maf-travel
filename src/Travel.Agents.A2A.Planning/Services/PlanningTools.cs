...
public static class PlanningTools
{
    ...
    private static string RequestInformation([Description("The details of the information request")] string message)
        => $"The information requested is: {message}";

    [Description("Request More Information")]
    private static string UpdateTravelPlan([Description("The update for the travel plan")] string message)
